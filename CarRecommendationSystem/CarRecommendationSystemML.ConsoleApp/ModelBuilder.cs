...
namespace CarRecommendationSystemML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"..\..\dataset.csv";
        private static string MODEL_FILEPATH = @"..\CarRecommendationSystemML.Model\MLModel.zip";
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.MulticlassClassification.CrossValidate(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "name");
